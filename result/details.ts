 ...
 * length: a family whose rows nest under a listing key had nothing
 * at the top level that was an array, so the bounding never ran.
 * The gate said that family was wired, because it was, and being
 * wired turned out to be a different claim from working.
 *
