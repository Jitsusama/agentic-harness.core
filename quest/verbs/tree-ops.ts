...
import {
	...
	isMainWorkingTree,
	isWithin,
} from "../../internal/quest/git-signals.js";
...
import { getTreeProvider, resolveTreeProvider } from "../../tree/index.js";
import { count, noun } from "../../ui/count.js";
import { displayPath } from "../../ui/path.js";
import type { QuestSession } from "../index.js";
...
export async function treePrune(
	...
	// `force` is a typed boolean parameter. The caller flips it only
	// after confirming destructive intent with the user. We
	// deliberately do NOT key off a `note` string because notes are
	// free-form prose, not consent. `force: true` is the consent
	// signal.
