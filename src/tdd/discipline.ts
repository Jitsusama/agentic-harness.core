 ...
 * sentences the agent should keep in mind while it's there. An
 * adapter injects these as a reminder, both in the reply when a
 * transition lands and in whatever persistent context mechanism
 * its host offers, so the discipline survives a long autonomous
 * run.
 */
