 ...
 * a downstream editor-forwarding backend registers below that
 * and reports itself available only under its own precondition,
 * so it takes over transparently when present.
 */
