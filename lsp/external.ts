/**
 * Validation for LSP backends registered from another process or
 * package boundary. A payload that crosses a trust boundary from
 * a third-party emitter is rejected rather than trusted.
 */
