...
import { ANNOUNCEMENT_OBSERVER } from "../../web/a11y/announcements.js";
import { FOCUS_PROBE } from "../../web/a11y/focus.js";
import {
	WALK_COLLECT,
	WALK_READ,
	WALK_REMEMBER,
	WALK_RESTORE,
} from "../../web/a11y/walkprobe.js";
import { TARGET_CAPTURE, visualCaptureSource } from "../../web/audit/probe.js";
import { inventorySource } from "../../web/design/probe.js";
import { ANIMATIONS_PROBE } from "../../web/element/animations.js";
import {
	OCCLUDER_PROBE,
	OWN_TEXT_PROBE,
	PAINTING_ELEMENT_PROBE,
	SELECT_TEXT_PROBE,
} from "../../web/element/probes.js";
import { SETTLE_PROBE } from "../../web/element/pseudo.js";
import { ENVIRONMENT_PROBE } from "../../web/environment/probes.js";
import { evaluationSource } from "../../web/evaluate/probe.js";
import { DEEP_DOM } from "../../web/snapshot/deep.js";
import { PRESENTED } from "../../web/snapshot/presented.js";
import {
	COMPUTED_STYLE_PROBE,
	INITIALS_PROBE,
} from "../../web/styles/capture.js";
import { settleSource } from "../../web/wait/settle.js";
